...
class MainActivity : AppCompatActivity() {
    ...
    private fun calPre(view: View){
        ...
        val spinnerSize = spinnerAge.selectedItemPosition + 1

        //gender
        val gender = findViewById<RadioGroup>(R.id.radioGroupGender)
        val genG = gender.checkedRadioButtonId
